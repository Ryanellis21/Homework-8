...
class MainWindow(qtw.QWidget, Ui_Form):
    ...
    def Calculate(self):
        # call the updateModel() method of the controller
        self.RC.updateModel()

    def SelectQualityOrTHigh(self):
        # call the selectQualityOrTHigh() methond of the controller
        self.RC.selectQualityOrTHigh()

    def SetPlotVariables(self):
        # call the updatePlot() method of the controller
        self.RC.updatePlot()

    def SetUnits(self):
        # call the updateUnits() method of the controller
        self.RC.updateUnits()

    def setNewPHigh(self):
        # call the setNewPHigh() function of the controller
        self.RC.setNewPHigh()

    def setNewPLow(self):
        # call the setNewPLow() function of the controller
        self.RC.setNewPLow()
